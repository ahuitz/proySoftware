...
<html>
<head>
<title>Amberegul A Ecommerce Category Flat Bootstarp Resposive Website Template | Register :: w3layouts</title>
		...
		<div class="container">
			<div class="header-top-in grid-1">
				...
				<ul class=" support-right">
					<li ><a href="iniciarsesion.php" ><i class="men"> </i>Iniciar sesión</a></li>
					</ul>
			...
			<div class="container">			
				<div class="logo">
					<h1><a href="index.php">Zroxbox</a></h1>
				</div>
				<div class="top-nav">
				<!-- start header menu -->
					...
					<div class="row">
						<div class="col1">
							<div class="h_nav">
								...
								<ul>
									...
									<li><a href="product.php">Ceras</a></li>
									<li><a href="product.php">accessorios</a></li>
						...
						<div class="col1">
							<div class="h_nav">
								<h4>Pinturas</h4>
								<ul>
									<li><a href="product.php">Jarrillas</a></li>
									<li><a href="product.php">Pistolas</a></li>
									<li><a href="product.php">Tiner</a></li>
									<li><a href="product.php">Brochas</a></li>
									<li><a href="product.php">Pasta</a></li>
									</ul>	
							</div>							
						</div>
						<div class="col1 col5">
...
<!---->
<div class="container">
	<h6 class="dress"><a href="index.php">Inicio</a> <i> </i> Registrarse </h6>
</div>
<div class="back">
	<h2>REGISTRO</h2>
</div>
